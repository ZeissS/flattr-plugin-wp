...
class Flattr_Settings
{
    ...
    public function register_settings()
    {
		...
		register_setting('flattr-settings-group', 'flattr_mod_exc', array($this, 'sanitize_modify_excerpts'));
		# Should the button be only shows in single view? (is_single() == true)
		register_setting('flattr-settings-group', 'flattr_only_single', array($this, 'sanitize_only_single'));
    }
    ...
    public function sanitize_only_single($only_single) {
		return ($only_single == 'true' ? 'true' : 'false');
    }
    
    public function sanitize_modify_excerpts($modify_excerpts) {
